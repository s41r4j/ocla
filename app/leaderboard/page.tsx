  ...
  return (
    <div className="relative min-h-screen py-12">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 space-y-8">
        ...
        {/* 1. Statistics Graph (Refusal Probabilities) - Moved to Top */}
        ...
        {/* 3. Model Rankings Table - Bottom */}
        <div className="overflow-hidden rounded-xl border border-white/10 bg-gray-900/40 backdrop-blur-md">
